...
import EduComponents from "../Screens/Components/eduComponents";
import VideoComponents from "../Screens/Components/VideoComponents";
  ...
  return (
    <SafeAreaView style={{width:'100%', flex: 1 }}>
      ...
      >
        ...
        <StackComponent.Screen name={"EduComponents"} component={EduComponents} />
        <StackComponent.Screen name={"VideoComponents"} component={VideoComponents} />
        <StackComponent.Screen name={"Grades"} component={Grades} />
        <StackComponent.Screen name={"Schedule"} component={Schedule} />
        <StackComponent.Screen name={"Notifications"} component={Notifications} />
        <StackComponent.Screen name={"ClassSchedule"} component={ClassSchedule} />
        <StackComponent.Screen name={"Contact"} component={Contact} />
