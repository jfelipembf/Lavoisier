                ...
                >
                    ...
                    <TouchableOpacity
                        style={{
                            ...
                            width:40,
                            borderRadius:10,
                            backgroundColor:COLORS.primayLight5,
                            alignItems:'center',
                            justifyContent:'center',
                            marginRight:10,
                        }}
                    >
                        <FontAwesome5 size={16} color={COLORS.primary5} name='phone-alt'/>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={{
                            height:40,
                    ...
                    >
                        <FontAwesome size={16} color={COLORS.primary5} name='video-camera'/>
                    </TouchableOpacity>
                </View>
                <View 
                    style={{flex:1}}
                ...
                >
                    ...
                    >
                        <View>
                            ...
                            >
                                <FeatherIcon color={COLORS.primary5} size={22} name='send'/>
                            </TouchableOpacity>
                        </View>
                    </View>
                </KeyboardAvoidingView>
